...
namespace VRM_Plugin.Core.Abstractions.Common;

/// <summary>
/// Helper para ejecutar stored procedures y mapear resultados a DTOs automáticamente.
/// 
/// ? NOTA ARQUITECTÓNICA:
/// Esta clase está en Common/ porque es una UTILIDAD COMPARTIDA genérica.
        ...
        foreach (DataRow row in dataTable.Rows)
        {
            ...
            foreach (var property in properties)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    Console.WriteLine($"?? Error mapeando propiedad {property.Name}: {ex.Message}");
                }
            }

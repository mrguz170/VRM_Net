...
using VRM_Plugin.Core.Abstractions.DTOs;
using VRM_Plugin.Core.Abstractions.Services;
using VRM_Plugin.Data.Common;

namespace VRM_Plugin.Data.Repositories.System;

/// <summary>
/// ✅ Repositorio en la capa de datos que implementa IModuleMetadataService
/// Contiene TODA la lógica de acceso a BD para metadata de módulos
/// </summary>

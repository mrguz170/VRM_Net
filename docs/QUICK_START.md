...
- **Permisos Granulares:** [docs/GUIA_SISTEMA_PERMISOS_GRANULARES.md](docs/GUIA_SISTEMA_PERMISOS_GRANULARES.md)
- **Integración de Cookies:** [docs/GUIA_INTEGRACION_COOKIES.md](docs/GUIA_INTEGRACION_COOKIES.md)
- **Renderizado Condicional:** [docs/SOLUCION_FINAL_RENDERIZADO_CONDICIONAL.md](docs/SOLUCION_FINAL_RENDERIZADO_CONDICIONAL.md)
